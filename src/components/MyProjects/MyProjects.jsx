...
const MyProjects = () => {
  const flashcardsImg = {
    background: `url(${flashcards}) center center/cover no-repeat`,
  };
  ...
  const projects = [
    ...
    },
    {
      ...
      backgroundStyle: carLeasingImg,
      link: "https://andrewchernoff.github.io/carleasing",
    },
    {
      title: "Quiz",
      backgroundStyle: quizImg,
      link: "https://andrewchernoff.github.io/quiz",
    },
    {
      title: "Counter",
      backgroundStyle: counterImg,
      link: "https://counter-gbz8.vercel.app/",
    },
    {
      title: "NBA players",
      backgroundStyle: lebronImg,
      link: "https://players-trading.vercel.app/",
    },
    {
      title: "Flashcards",
      backgroundStyle: flashcardsImg,
      link: "https://flashcards-3d8nivnys-andrewchernoff.vercel.app/",
    },
  ];
  ...
  return (
    <div className={style.projectsBlock} id="myWorks">
      <div className={`${styleContainer.container} ${style.projectsContainer}`}>
        <Title
          title={"My Projects"}
          titleDescr={"Some of my recent projects"}
        />
